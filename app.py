...
# i create contact page and when i click send button data should not insert in database it gives error 

# [![enter image description here][2]][2]


#   [1]: https://i.stack.imgur.com/Wp0In.png
#   [2]: https://i.stack.imgur.com/UR6a8.png